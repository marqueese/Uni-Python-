class Laptop:
    ...
    @ssd.setter
    def ssd(self, ssd_type):
        if ssd_type in self.ssd_options:
            self._ssd = ssd_type
...
def test_laptop():
    ...
    laptop.ram = 16
    print(f"Laptop's RAM is {laptop.ram} GB with a cost of £{laptop.ram_options[laptop.ram]}")

    laptop.ssd = 256
    print(f"Laptop's SSD is {laptop.ssd} GB with a cost of £{laptop.ssd_options[laptop.ssd]}")
